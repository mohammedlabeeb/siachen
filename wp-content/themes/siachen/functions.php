...
require_once('includes/siachen.class-countries.php');
require_once('includes/ajax_functions.php');
require_once('includes/custom_fucntions.php');
...
function simple_boostrap_register_sidebars() {
    ...
    register_sidebar(array(
      'id' => 'footer1',
      'name' => __('Footer1', 'simple-bootstrap'),
      'before_widget' => '<div id="%1$s" class="widget col-xs-6 col-sm-3 col-md-3 %2$s">',
      'after_widget' => '</div>',
      'before_title' => '<h4>',
      'after_title' => '</h4>',
    ));
	...
	register_sidebar(array(
      'id' => 'footer2',
      'name' => __('Footer2', 'simple-bootstrap'),
      'before_widget' => '<div id="%1$s" class="widget col-xs-6 col-sm-5 col-md-5 %2$s">',
      'after_widget' => '</div>',
      'before_title' => '<h4>',
      'after_title' => '</h4>',
    ));
	...
	register_sidebar(array(
      'id' => 'footer Last',
      'name' => __('Footer4', 'simple-bootstrap'),
      'before_widget' => '<div id="%1$s" class="widget col-right">',
      'after_widget' => '</div>',
      'before_title' => '<h4>',
      'after_title' => '</h4>',
    ));
...
function simple_boostrap_display_post($multiple_on_page) { ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class("block"); ?> role="article">
        ...
        <header>
            ...
            <?php if(!is_page()) simple_bootstrap_display_post_meta() ?>
...
add_image_size('sia_thumb',230,230,true);
add_image_size('sia_banner',1096,230,true);
add_role(
    'business_user',
    __( 'Business User' ),
    array(
